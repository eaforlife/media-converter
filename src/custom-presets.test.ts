...
const preset: SavedPreset = {
  ...
  filters: { autoCrop: true, toneMapHdrToSdr: true, pixelFormat10Bit: false, scale: 'auto', scaleLocked: false, remuxAudio: true, remuxSubtitles: true, stripMetadata: true, doNotReplaceAudio: false, extractClosedCaptions: false, downmixToStereo: true, resampleLosslessTo48k: true, normalizeAudio: true },
};
